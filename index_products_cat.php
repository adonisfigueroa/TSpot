<?php 
	global $body_classes;
	$body_classes = array('interior','products','products-cat');
	...
	<div class="wrapper">
		<div class="col-2-3">
			<div class="wrapperMobileOnly">	
				...
				<div id="ShowingFilter">
					<span>Currently Showing:</span>
					<ul class="pills">
  					<li class="blue checked"><a href="#">AMD</a></li>
  					<li class="blue checked"><a href="#">Intel</a></li>
					</ul>
				</div>
				<div id="AddFilter">
				
					<div class="sorter">
      			Sorted by <a href="#sorter" class="open"><span id="sorted_by">popularity</span></a>
      			<ul>
      				<li><a href="#" data-sort="popularity" class="sort active">Popularity</a></li>
      				<li><a href="#" data-sort="score" class="sort">Score</a></li>
      				<li><a href="#" data-sort="price-asc" class="sort">Price <span class="smaller">(Low to high)</span></a></li>
      				<li><a href="#" data-sort="price-desc" class="sort">Price <span class="smaller">(High to low)</span></a></li>
      			</ul>
      		</div>
					
					<span>Add Filter:</span>
					<ul class="pills">
  					<li class="grey"><a href="#">Score</a></li>
  					<li class="grey"><a href="#">Price</a></li>
  					<li class="grey"><a href="#">Release Date</a></li>
					</ul>
					...
					<?php for($i=0;$i<20;$i++) : ?>
						<article>
							<div class="product-img">
								<img src="images/tmp/post-image-1.jpg" alt="post-image-1" />
							</div><!-- /.article-img -->
				...
				<ul>
				    ...
				    <li class="open has_more">
				        ...
				        <ul class="sub">
				            ...
				            <li>
				                <a href="/products/laptops/" class="active">
				                    <span class="arrow"></span> Laptops																
				                </a>
				            </li>
				        	</div>
