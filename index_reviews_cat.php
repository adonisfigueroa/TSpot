<?php 
	global $body_classes;
	$body_classes = array('interior','reviews', 'reviews-cat');
	...
	<div class="wrapper">
		...
		<div class="col-2-3">
			...
			<div id="ShowingFilter">
				...
				<div class="ShowOnly">
					<ul>
						<li class="green"><a href="#">› Show me only AMD Reviews</a></li>
						<li class="red"><a href="#">› Show me only Intel Reviews</a> </li>
					</ul>
				</div>
			</div>
		</div>
